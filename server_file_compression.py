import boto
from aws_server import server

def start_server(aws_access_key_id,aws_secret_access_key,size,software_name,key_name,instance_type,security_groups,user_data):
    s = server() #initlize the server class to "s"
    s.Server_Start_up(aws_access_key_id,aws_secret_access_key,size,software_name,key_name,instance_type,security_groups,user_data)  # call the start up function 
    return 

def data(aws_access_key_id,aws_secret_access_key,folder,bucket_name):
...
if __name__ == "__main__":
    ...
    folder = raw_input("folder to compress: ")
    workers = raw_input("amount of workers to download: ")
    size  = raw_input("size of server: 2.5x backup: ")
    ...
    instance_type = ""
    security_groups= ""
    user_data = data(aws_access_key_id,aws_secret_access_key,folder,bucket_name)
    
    
    
    
    start_server(aws_access_key_id,aws_secret_access_key,size,software_name,key_name,instance_type,security_groups,user_data)
